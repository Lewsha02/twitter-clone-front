...
// 3. Сделать правую часть твиттера
// 4. Попытаться приветси к такому же размеру гриды, как и в Твиттере
              ...
              ...new Array(20).fill(
                <Tweet
                  ...
                  user={{
                    ...
                    avatarUrl:
                      "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80",
                  }}
                  classes={classes}
                />
              ),
